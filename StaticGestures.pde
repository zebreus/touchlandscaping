...
void setupOneDollar() {
  ...
  //one.on("rectangle x", "printStaticGesture");
...
void printStaticGesture(String gestureName, float percentOfSimilarity, int startX, int startY, int centroidX, int centroidY, int endX, int endY) {
